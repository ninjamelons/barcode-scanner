...
namespace BScanner
{
    ...
    private:
        virtual std::pair<std::string, std::pair<unsigned short, unsigned short>>
            decodeValue(std::vector<int> row) = 0; // decodes specific row
    ...
    public:
        ...
        virtual ~Decoder(); // public destructor
    };
}   
